...
def check_conflict_circle_circle_magnets(magnet_pair):
    ...
    for magnet_1, magnet_2 in zip([0, 1], [1, 0]):
        ...
        for pickup_area in magnet_pair[magnet_1].create_pickup_areas():
            ...
            if points:
                ...
                all_blocked_pickup_areas.append(blocked_magnet(magnet_pair[magnet_2], magnet_pair[magnet_1], pickup_area))
